        ...
        <main className={styles.mainContent}>
          ...
          <div className={styles.initialInputs}>
            <div className={styles.inputGroup}>
              ...
              <input id="current-cgpa" className={styles.textInput} type="number"
                step="0.01" min="0" max="5" value={currentCgpa}
            ...
            <div className={styles.inputGroup}>
              ...
              <input id="total-units" className={styles.textInput} type="number"
                min="0" value={totalUnits}
            ...
            <div className={styles.inputGroup}>
              ...
              <select id="semester-count" className={styles.selectInput}
                value={semesterCount}
                        ...
                        <tr key={course.id}>
                          ...
                          <td>
                            <button className={styles.deleteRowBtn}
                              onClick={() => deleteCourse(sem.id, course.id)} title="Delete course">
